...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        // 红色盘
        _rSlider = [[UISlider alloc] initWithFrame:CGRectMake(20, 10, CGRectGetWidth(self.frame)-160, 30)];
        ...
        // 调色盘
        _pView = [[UIView alloc] initWithFrame:CGRectMake(CGRectGetMaxX(self.frame)-120, CGRectGetMinY(_rSlider.frame), 100, 60)];
        _pView.layer.cornerRadius = 15;
        _pView.layer.masksToBounds = YES;
        [self addSubview:_pView];
        
        // 显示宽度
        _wLabel = [[UILabel alloc] initWithFrame:CGRectMake(CGRectGetMinX(_pView.frame), CGRectGetMaxY(_bSlider.frame), 60, 30)];
